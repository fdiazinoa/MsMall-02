...
import { SaleReport, IngestionResponse, DateRange, KPIData, User, ImportConfig, SaleDetail, ImportProtocol, FileType, ImportFrequency, RemoteConnection, BigDataSummary, BigDataCategory, BigDataRanking } from './types';
